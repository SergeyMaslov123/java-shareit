...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> addItem(ItemRequestDto itemDto, Long userId) {
    ...
    public ResponseEntity<Object> addComments(CommentRequestDto commentDto, Long itemId, Long userId) {
